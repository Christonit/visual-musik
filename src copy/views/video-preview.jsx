    ...
    return(
        <div className="video-preview">
            <div className="youtube-container-header">
                ...
                <button className="material-icons button-glass" onClick={()=> dispatch(close_video_prev () )}>close</button>
            </div>
            
            <iframe width="100%" height="280" 
            src={`https://www.youtube.com/embed/${id}`}
            allow="accelerometer; autoplay; gyroscope; picture-in-picture" 
            title="YouTube video player" className="mb--16" frameborder="0"></iframe>

            <div className="mb--32">
                <h3 className="subtitle mb--16">{snippet.title}</h3>
                <p className="text label">Channel: <b>{snippet.channelTitle}</b></p>
            </div>

            <div className="stats-container">
                <div className="stats-element">
                    <span className="material-icons mb--4">
                        visibility
                    </span>
            ...
            <div style={{textAlign:'center'}}>
                <a href={`https://www.youtube.com/watch?v=${id}`} target="_blank" className="youtube-button">VIEW ON YOUTUBE</a>
            </div>
